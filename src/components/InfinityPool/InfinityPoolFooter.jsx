...
function InfinityPoolFooter() {
  return (
    <footer className="bg-[#0A2E50] text-white py-16"> 
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        <div className="grid md:grid-cols-3 gap-12 mb-12 items-start">
          {/* About Section */}
          <div className="text-left md:text-center">
            <h3 className="text-3xl font-serif font-bold text-[#DAA520] mb-5">360° Infinity Pool</h3> {/* Gold heading */}
            <p className="leading-relaxed text-lg text-gray-300">
              Experience boundless serenity where the sky meets the water, offering unparalleled views and relaxation.
            </p>
          </div>
          ...
          <div className="text-left md:text-center">
            ...
            <ul className="space-y-3 text-gray-300">
              <li><Link smooth to="/InfinityPool#home" className="hover:text-[#FFD700] transition duration-300 text-lg">Home</Link></li>
              <li><Link smooth to="/InfinityPool#about" className="hover:text-[#FFD700] transition duration-300 text-lg">About</Link></li>
              <li><Link smooth to="/InfinityPool#gallery" className="hover:text-[#FFD700] transition duration-300 text-lg">Gallery</Link></li>
              <li><Link smooth to="/InfinityPool#contact" className="hover:text-[#FFD700] transition duration-300 text-lg">Contact</Link></li>
            </ul>
          </div>
          ...
          <div className="text-left md:text-center">
            ...
            <p className="mb-3 text-lg text-gray-300">Rooftop, The Paradise Hotel, Udaipur</p>
            <p className="mb-3 text-lg text-gray-300">+91 7597 93 9090</p>
            <p className="text-lg text-gray-300">poolaccess@theparadise.com</p>
            {/* Social Media Icons */}
        ...
        <div className="border-t border-gray-700 pt-8 text-gray-400 text-base">
          <p>&copy; {new Date().getFullYear()} The Paradise Hotel. All rights reserved.</p>
          <p className="mt-2">A signature experience by The Paradise Group.</p>
        </div>
      </div>
    </footer>
  );
...
export default InfinityPoolFooter;
