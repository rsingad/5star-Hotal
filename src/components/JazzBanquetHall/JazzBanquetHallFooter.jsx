...
function JazzBanquetHallFooter() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
        <div className="grid md:grid-cols-3 gap-12 mb-12 items-start">
          ...
          <div className="text-left md:text-center">
            <h3 className="text-3xl font-serif font-bold text-[#DAA520] mb-5">Jazz Banquet Hall</h3> {/* Gold heading */}
            <p className="leading-relaxed text-lg text-gray-300">
              The perfect venue for grand celebrations and unforgettable events, offering elegance and impeccable service.
            </p>
          </div>
          ...
          <div className="text-left md:text-center">
            ...
            <ul className="space-y-3 text-gray-300">
              <li><Link smooth to="/JazzBanquetHall#home" className="hover:text-[#FFD700] transition duration-300 text-lg">Home</Link></li>
              <li><Link smooth to="/JazzBanquetHall#about" className="hover:text-[#FFD700] transition duration-300 text-lg">About</Link></li>
              <li><Link smooth to="/JazzBanquetHall#gallery" className="hover:text-[#FFD700] transition duration-300 text-lg">Gallery</Link></li>
              <li><Link smooth to="/JazzBanquetHall#contact" className="hover:text-[#FFD700] transition duration-300 text-lg">Inquire</Link></li>
            </ul>
          </div>
          ...
          <div className="text-left md:text-center">
            ...
            <p className="text-lg text-gray-300">events@theparadise.com</p>
            {/* Social Media Icons */}
        ...
        <div className="border-t border-gray-700 pt-8 text-gray-400 text-base">
          <p>&copy; {new Date().getFullYear()} Jazz Banquet Hall. All rights reserved.</p>
          <p className="mt-2">A premier venue by The Paradise Group.</p>
        </div>
      </div>
    </footer>
  );
...
export default JazzBanquetHallFooter;
